package com.requestappengine;

import com.requestappengine.EMF;
...
@Api(name = "deviceinfoendpoint", namespace = @ApiNamespace(ownerDomain = "requestappengine.com", ownerName = "requestappengine.com", packagePath = ""))
